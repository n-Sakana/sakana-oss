...
- `tools/toolrack/` — Windows右クリックメニューから小型ツール群を起動するPowerShellツールラック
- `tools/xltoolrack/` — Excelアドイン上でVBAツールを並行実行するxltoolrack
...
特記なき限り、本リポジトリの内容は MIT License で公開する。
